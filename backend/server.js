...
app.get("/sitemap.xml", async (req, res) => {
  try {
    ...
    const staticPages = [
      { url: '/', lastmod: '2025-06-09', changefreq: 'weekly', priority: '1.0' },
      { url: '/login', lastmod: '2025-06-09', changefreq: 'monthly', priority: '0.6' },
      { url: '/signup', lastmod: '2025-06-09', changefreq: 'monthly', priority: '0.6' },
      { url: '/accept-invite', lastmod: '2025-06-09', changefreq: 'monthly', priority: '0.5' },
      { url: '/confirm-email', lastmod: '2025-06-09', changefreq: 'monthly', priority: '0.5' },
      { url: '/onboarding', lastmod: '2025-06-09', changefreq: 'monthly', priority: '0.6' },
      { url: '/dashboard', lastmod: '2025-06-09', changefreq: 'weekly', priority: '0.8' },
      { url: '/conversations', lastmod: '2025-06-09', changefreq: 'daily', priority: '0.8' },
      { url: '/agent-config', lastmod: '2025-06-09', changefreq: 'weekly', priority: '0.7' },
      { url: '/widget-config', lastmod: '2025-06-09', changefreq: 'weekly', priority: '0.7' },
      { url: '/analytics', lastmod: '2025-06-09', changefreq: 'weekly', priority: '0.7' },
      { url: '/pricing', lastmod: '2025-06-09', changefreq: 'monthly', priority: '0.8' },
      { url: '/team', lastmod: '2025-06-09', changefreq: 'weekly', priority: '0.7' },
      { url: '/tests', lastmod: '2025-06-09', changefreq: 'monthly', priority: '0.5' },
      { url: '/blog', lastmod: '2025-06-09', changefreq: 'weekly', priority: '0.9' },
    ];
...
${blogPosts.map(post => `
  <url>
    ...
    <lastmod>${post.updated_at ? new Date(post.updated_at).toISOString() : '2025-06-09'}</lastmod>
