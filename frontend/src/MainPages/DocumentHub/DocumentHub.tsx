...
export default function DocumentHub() {
  const [activeVessel, setActiveVessel] = useState("Humble Warrior")
  ...
  const openUploadModal = (type: "single" | "batch") => {
    setSelectedVesselForUpload(activeVessel)
    if (type === "single") {
  ...
  return (
    <div className="flex flex-col h-screen">
      ...
      <div className="flex flex-1 overflow-hidden">
        {/* Sidebar - replaced with MyFleet component */}
        <MyFleet activeVessel={activeVessel} onVesselSelect={setActiveVessel} onUploadClick={openUploadModal} />

        {/* Main Content Area */}
        <main className="flex-1 overflow-auto p-6">
          <div className="flex justify-between items-center mb-6">
            <div>
              <h1 className="text-2xl font-bold">Humble Warrior</h1>
              <p className="text-gray-500">Crude Oil Tanker • Panama • IMO: 9876543</p>
            </div>
...
function VesselCard({ name, type, flag, active, onClick, documentStatus }) {
  return (
    <div
