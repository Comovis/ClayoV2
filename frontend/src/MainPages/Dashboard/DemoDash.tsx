    ...
    <div className="p-6 max-w-7xl mx-auto space-y-6 bg-white min-h-screen">
          ...
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h3 className="font-semibold text-black">{organization.name}</h3>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <Card className="border-gray-200">
          ...
          <CardContent>
            <div className="text-2xl font-bold text-black">
              {isDashboardLoading ? "..." : stats.activeConversations}
            </div>
            <p className="text-xs text-gray-600">
        ...
        <Card className="border-gray-200">
          ...
          <CardContent>
            <div className="text-2xl font-bold text-black">{isDashboardLoading ? "..." : stats.avgResponseTime}</div>
            <p className="text-xs text-gray-600">
              <span className="text-green-600 flex items-center">
        ...
        <Card className="border-gray-200">
          ...
          <CardContent>
            <div className="text-2xl font-bold text-black">
              {isDashboardLoading ? "..." : `${stats.aiResolutionRate}%`}
            </div>
            <p className="text-xs text-gray-600">
              <span className="text-green-600 flex items-center">
                <ArrowUpRight className="h-3 w-3 mr-1" />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2">
          <Card className="border-gray-200">
            <CardHeader>
              <div className="flex items-center justify-between">
                <div>
                  <CardTitle className="text-black">Recent Conversations</CardTitle>
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-2">
                          <h4 className="font-medium truncate text-black">{conversation.customer.name}</h4>
        ...
        <div className="space-y-6">
          ...
          <Card className="border-gray-200">
            <CardHeader>
              <CardTitle className="text-lg text-black">Performance</CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
              {isDashboardLoading ? (
                ...
                <>
                  <div>
                    <div className="flex justify-between text-sm mb-2">
                      ...
                      <span className="font-medium text-black">{stats.customerSatisfaction}/5.0</span>
                    </div>
                  ...
                  <div>
                    <div className="flex justify-between text-sm mb-2">
                      ...
                      <span className="font-medium text-black">{stats.aiResolutionRate}%</span>
                    </div>
                  ...
                  <div>
                    <div className="flex justify-between text-sm mb-2">
                      ...
                      <span className="font-medium text-black">Under 5min</span>
                    </div>
          ...
          <Card className="border-gray-200">
            <CardHeader>
              <div className="flex items-center justify-between">
                <CardTitle className="text-lg text-black">Recent Leads</CardTitle>
                ...
                recentLeads.map((lead) => (
                  ...
                  >
                    <div className="flex justify-between items-start mb-2">
                      <h4 className="font-medium text-sm text-black">{lead.title}</h4>
                      <Badge variant="outline" className="text-xs">
                        {lead.status}
                      </Badge>
                    </div>
