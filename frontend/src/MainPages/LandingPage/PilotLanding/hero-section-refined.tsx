        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight text-slate-900 mb-6 leading-tight">
              Never Miss Another Document Expiry or Port Requirement
            </h1>

            {/* Clear value proposition */}
            <p className="text-xl text-slate-600 mb-8 leading-relaxed">
              Maritime compliance shouldn't be a constant source of stress. Comovis securely organizes all your maritime
              documents, tracks expiry dates, and provides real-time port intelligence—accessible to your entire team,
            ...
            <div className="grid grid-cols-2 gap-6">
              ...
              <div className="flex items-start">
                ...
                <div>
                  <h3 className="font-medium text-slate-900">Organize All Documents</h3>
  ...
  return (
    <div className="relative mb-16">
      ...
      <motion.div
        ...
        className="absolute -bottom-8 -left-8 bg-white rounded-lg shadow-xl p-4 border border-slate-200 z-20"
      >
        <div className="text-center">
          <div className="text-2xl font-bold text-slate-900">99.2%</div>
          <p className="text-slate-600 text-sm">Prevention Rate</p>
        </div>
      </motion.div>
